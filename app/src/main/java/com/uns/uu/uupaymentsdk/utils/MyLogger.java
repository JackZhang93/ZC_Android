...
/**
 * Created by peixuan.xie on 2016/8/12.
 */
public class MyLogger {
    ...
    private static final String NAMES           = "@jpx@ ";
     ...
     * @return
     */
    public static MyLogger kLog(String name)
    {
        if(klog == null)
        {
            klog = new MyLogger(name);
        }
        return klog;
    }
    /**
